...
- freeNAS [Storage Gateway Part 2a - Create a new dataset](https://youtu.be/kt5hubC1tX0) and [Part2b]() following the document [Netstack Freenas - Setup - SMB Share](https://github.com/2cld/netstack/blob/master/docs/lan/storage/freenas/setup.md#freenas-smb-share-dataset-configuration)
