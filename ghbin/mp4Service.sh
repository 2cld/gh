								...
								then
									...
									then
										...
										then
											...
											# If the dailies folder doesn't already exist, make it.
											if [ -d $dailiesPath ]
											then
											...
											touch $dailiesPath$basename.mp4
											# Copy the mp4 from the G drive to the dailies folder.
											cp -f $ghPath$basename.mp4 $dailiesPath$basename.mp4
									...
									echo "There are no frames for this bucket"
								fi
							# else
